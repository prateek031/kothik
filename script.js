...
document.querySelector("#homee")
.addEventListener("mousemove", function(){
  document.querySelector("#slider-upar-wala").style.marginTop = "0%"
  document.querySelector("#homee").style.cursor = "pointer"
})
document.querySelector("#aboutt")
.addEventListener("mousemove", function(){
  document.querySelector("#slider-upar-wala").style.marginTop = "-50vh"
  document.querySelector("#aboutt").style.cursor = "pointer"
})
